    ...
    <div className="relative w-screen h-screen flex items-center justify-center px-4 md:px-10 lg:px-20 text-gray-900 dark:text-white">
      ...
      <div className="absolute left-1/2 transform -translate-x-1/2 w-[90%] md:w-[70%] lg:w-[60%] text-center px-4 py-10 bg-opacity-50 z-10 h-full rounded-3xl flex justify-center items-center p-4">
        <div className="bg-white shadow-xl rounded-3xl p-8 max-w-md w-full text-center flex flex-col justify-center">
          <div className="mb-6">
            <h2 className="text-2xl font-bold text-green-800 mb-2">Results Ready!</h2>
            <p className="text-gray-700 mb-4">
              Get your complete mental health assessment results after a small fee.
            </p>
            <div className="bg-green-50 border border-green-200 rounded-lg p-3 mb-6">
              <p className="text-green-700 font-medium">
                Your assessment will include:
              </p>
              <ul className="text-left text-sm mt-2 space-y-1 text-gray-700">
                <li className="flex items-center">
                  ...
                  Detailed mental health analysis
                </li>
                <li className="flex items-center">
                  <svg className="w-4 h-4 mr-2 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path>
          ...
          <div className="space-y-4">
            ...
            {/* PayPal Payment Card */}
            {activeMethod === "paypal" && (
              <div className="bg-white rounded-xl shadow-lg p-6 border-2 border-blue-200 transition-all duration-300">
            ...
            {activeMethod === "mpesa" && (
              <div className="bg-white rounded-xl shadow-lg p-6 border-2 border-green-200 transition-all duration-300">
                ...
                <div className="w-full flex flex-col items-center">
                  <label htmlFor="phone" className="block text-gray-700 mb-2 self-start font-medium">
                    Enter Phone Number
                  </label>
                  <MuiTelInput
                    value={phone_number}
