      ...
      <div className="z-20 max-w-md w-full px-4">
        <div className="bg-white text-black shadow-xl rounded-2xl py-8 px-6 text-center relative overflow-hidden">
          ...
          <p className="text-gray-700 font-bold mb-6">
            Do you want to confirm your answers?
            <br />
          ...
          <button
            ...
            className="w-full bg-purple-600 text-white px-6 py-3 rounded-full hover:bg-purple-700 transition duration-300 text-lg font-medium shadow-md"
          >
            Get My Results
          </button>
